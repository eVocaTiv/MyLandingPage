...
function Elf({ layer = DEFAULT_LAYER }) {
  ...
  const material = useMemo(() => {
    if (layer === DEFAULT_LAYER) return new THREE.MeshStandardMaterial({ color: new THREE.Color('#407C80'), roughness: 1, metalness: 0.9 })
  ...
  return (
    <group ref={group}>
      <group rotation={[-1.5707963267948963, 0, 0]} position={[-2, 4.5, -5]}>
...
function App() {
  return (
    <StyledCanvas
      onMouseMove={(e) => console.log('moved')}
      shadowMap
